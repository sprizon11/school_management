...
import { TeacherUpdateStudentDto } from './dto/update-student.dto';
...
export class TeacherController {
  ...
  studentDetail(
    ...
    return this.teacher.studentDetail(user.teacherId, id);
  }

  @Patch('students/:id')
  updateStudent(
    @Param('id') id: string,
    @Body() dto: TeacherUpdateStudentDto,
    @CurrentUser() user: { teacherId: string },
  ) {
    return this.teacher.updateStudentDetails(user.teacherId, id, { ...dto });
  }
  ...
  @Get('leave')
  leaves(@CurrentUser() user: { teacherId: string }) {
    return this.teacher.listLeaves(user.teacherId);
  }
  ...
  reviewLeave(
    ...
    return this.teacher.reviewLeave(
      user.teacherId,
      id,
      dto.approve,
      dto.note,
