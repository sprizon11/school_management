...
class _AdminMoreScreenState extends ConsumerState<AdminMoreScreen> {
          ...
          Expanded(
            child: AdminScreenBody(
              ...
              child: ListView(
                ...
                children: [
                  EntranceFade(child: _profileCard(fullName, schoolName)),
  ...
  Widget _header() {
    return AdminScreenHeader(
      ...
      iconColor: const Color(0xFF6D5DE8),
      subtitle: 'Manage your school and app settings',
      actions: [
        AdminHeaderIconButton(
          icon: Icons.notifications_none_rounded,
          // Static dot, as before — this screen doesn't load announcements, so
          // there's no real unread state to drive it.
          showDot: true,
          onTap: () => _open(const AdminAnnouncementsScreen()),
        ),
      ],
